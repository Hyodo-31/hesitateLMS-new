...
<body>
    ...
    <script>
        ...
        const featureDescriptions = {
            ...
            "totalDDIntervalTime": "D&D(ドラッグ＆ドロップ)から次のD&Dまでの時間の合計値。長いほど、迷いが生じた際に、単語と単語の選択の間が長いことを示唆します。",
            "maxDDIntervalTime": "D&D(ドラッグ＆ドロップ)から次のD&Dまでの時間の最大値。長いほど、迷いが生じた際に、単語と単語の選択の間が長いことを示唆します。",
            ...
            "hesitation": "問題解答中に迷いが発生した割合を示します。値が高いほど、迷いが多いことを意味します。"
        };
