...
require "../../dbc.php";
$sql = "select MAX(WID) as maxwid from question_info_ja";
...
<form action = "entry.php" method="post">
      <b>**　<?= translate('new.php_67行目_英文') ?>　**</b><br><?= translate('new.php_67行目_英語で入力') ?><br><br><input type="text" name="English" size="50" class="input"><br><br>
<b>**　<?= translate('new.php_66行目_日本語文') ?>　**</b><br><?= translate('new.php_66行目_日本語で入力') ?><br><br><input type="text" name="Sentence" size="50" style="ime-mode:disabled;" class="input"><br><br>
